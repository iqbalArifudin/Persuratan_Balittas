<div class="alert alert-secondary" role="alert">
    <i class="fas fa-fw fa-tachometer-alt"></i> Beranda &nbsp; &nbsp; > &nbsp;  &nbsp;<i class="fas fa-fw fa-cog"></i> Kelola Surat &nbsp; &nbsp; > &nbsp;  &nbsp;<i class="fas fa-envelope"></i> Tambah Surat
</div>
          ...
          <div class="col">
              <div class ="card">
                    ...
                    <?php endforeach ?> 
                        ...
                        <div class="form-group">
                            <label for="nim">Tanggal Surat</label>
                            <input type="date" class="form-control" id="tgl_masuk" name="tgl_masuk">
                        </div>

                        <label for="">File Surat</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="file_surat" name="file_surat" required autofocus>
