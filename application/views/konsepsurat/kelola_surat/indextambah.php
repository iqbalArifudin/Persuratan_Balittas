        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    <a class='btn btn-success' href="surat/tambahsurat">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class='btn btn-success'
                                        ...
                                        href="<?= base_url().'konsepsurat/surat/hapus/'.$srt->id_surat ?>">
                                        <i class="fa fa-trash" aria-hidden="true"><span> Hapus</span></i>
                                    </a>
                                    <a class='btn btn-primary'
                                        href="<?= base_url().'konsepsurat/surat/editsurat/'.$srt->id_surat ?>">
                                        <i class="fas fa-edit" aria-hidden="true"><span> Edit</span></i>
                                    </a>
                                    <a class='btn btn-warning'
                                        href="<?php echo base_url().'konsepsurat/surat/download/'.$srt->id_surat; ?>">
